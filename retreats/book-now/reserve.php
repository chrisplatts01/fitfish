...
<head>
	<meta charset="utf-8" />
 	<title>Fitfish booking enquiry</title>
	<link rel="stylesheet" href="/_/css/main.css" />
</head>
<body style="background-image: none;">
<div id="page-content" style="padding: 20px;">
<h1 style="color:#265e80">Fitfish booking enquiry</h1>
...
<?php
	...
	if ( empty($errors)) {
		...
		// $email_to      = "chris@virelai.co.uk";
		$email_subject = "Fitfish booking";

		// Get submitted form data
		$name = $_POST["Name*"];
		$email_from = $_POST["Email*"];
		$message = "BOOKING FORM\n\nYou have received an booking.\nThe details are:\n\n";
		$message .= "----------------------------------------\n";
		foreach ($_POST as $key=>$value) {
			$message .= "$key = $value\n\n";
		}
		...
		if ($sent) {
			echo "<p>Thank you for booking a retreat with Fitfish. We have a space saved for you and it will be great to have you there!
				As places go quickly to secure this place please use the button below to pay your deposit.</p>\n";
			...
			echo "</ul>\n";
			echo '<p>Please use the PayPal button, below, to secure your place. We will then be in touch via email with further information. Many thanks!</p>';
			echo '<form action="https://www.paypal.com/cgi-bin/webscr" method="post" style="text-align: center">
				<input type="hidden" name="cmd" value="_s-xclick">
				<input type="hidden" name="hosted_button_id" value="M34KPEYVN8ARC">
		...
		// Problem sending the email
			...
			echo "<p>There has been an error sending your message. Please try again later.</p>";
		}
	}
